...
export default function SuccessStories() {
  const stories = [
    ...
    },
    {
      ...
      challenge: 'Ansiedad por separación severa',
      solution: 'Terapia de comportamiento gradual con técnicas de desensibilización',
      result: 'Luna puede quedarse sola en casa hasta 6 horas sin mostrar signos de ansiedad. Sus dueños reportan una mejora del 95% en su comportamiento.',
      duration: '12 semanas',
    },
    {
      name: 'Rocky',
